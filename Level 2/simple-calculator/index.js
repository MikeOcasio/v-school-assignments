let form = document["smplCalculator"];

const addResult = form.querySelector("#add").querySelector("#addResult");
...
addResult.addEventListener("click", function (event) {
  ...
  let li = document.getElementById("addd");
  console.log(li);
  li.textContent = `${num1}` + " + " + `${num2}` + " = " + `${addSum}`;
  console.log(addSum);
});
const subResult = form
  .querySelector("#sub")
...
const multiResult = form
  .querySelector("#mul")
  .querySelector("#multiResult");
